...
(function ($) {
    ...
    // Alerts
    ubit.alert = new Object();

    ubit.alert.success = function (msg = 'İşlem başarıyla gerçekleştirildi.', time = 1500, showConfirmButton = true) {
        Swal.fire({
            title: "Başarılı",
            text: msg,
            icon: "success",
    ...
    ubit.alert.fail = function (msg = 'İşlem başarısız.') {
        Swal.fire({
            title: "Hata",
            text: msg,
            icon: "error",
